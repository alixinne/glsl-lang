...
fn parse_vulkan_types() {
    ...
    fn uniform_decl(name: &'static str, ty: ast::TypeSpecifierNonArray) -> ast::ExternalDeclaration {
        ast::ExternalDeclarationData::Declaration(
            ast::DeclarationData::InitDeclaratorList(
                ast::InitDeclaratorListData {
                    head: ast::SingleDeclarationData {
                        ty: ast::FullySpecifiedTypeData {
                            qualifier: Some(ast::TypeQualifierData {
                                qualifiers: vec![ast::TypeQualifierSpecData::Storage(
    ...
    let expected = ast::TranslationUnit(vec![
        ...
        uniform_decl("u10", ast::TypeSpecifierNonArrayData::Texture2DMsArray.into()),
        uniform_decl("u11", ast::TypeSpecifierNonArrayData::TextureCubeArray.into()),
        ...
        uniform_decl("u17", ast::TypeSpecifierNonArrayData::ITexture1DArray.into()),
        uniform_decl("u18", ast::TypeSpecifierNonArrayData::ITexture2DArray.into()),
        ...
        uniform_decl("u21", ast::TypeSpecifierNonArrayData::ITexture2DMsArray.into()),
        uniform_decl("u22", ast::TypeSpecifierNonArrayData::ITextureCubeArray.into()),
        ...
        uniform_decl("u29", ast::TypeSpecifierNonArrayData::ISubpassInputMs.into()),
        uniform_decl("u30", ast::TypeSpecifierNonArrayData::USubpassInputMs.into()),
    ]);

    let src = include_str!("../data/tests/vulkan_types.glsl");
    let parsed = ast::TranslationUnit::parse_with_options(src, &ParseOptions {
        target_vulkan: true, ..Default::default()
    }).map(|x| x.0);
